...
if (!fs.existsSync('../../ssr-app/build/asset-manifest.json')) {
  console.warn('../../ssr-app/build/asset-manifest.json does not exist - has the build run?')
  process.exit(1);
}
...
output.write('\n// asset-manifest.json\nvar assetManifest = ');
output.write(fs.readFileSync('../../ssr-app/build/asset-manifest.json', 'utf8'));
output.write(';\n\n');
